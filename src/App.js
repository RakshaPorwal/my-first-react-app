  ...
  return (
    <>
      ...
      <div className="container-fluid bg-primary text-white px-0 px-md-5 mb-5">
        <div className="row align-items-center px-3">
          <div className="col-lg-6 text-center text-lg-left">
            ...
            <Link to="/resources" className="btn btn-secondary mt-1 py-3 px-5 me-2">Explore Resources</Link>
          </div>
          <div className="col-lg-6 text-center">
            <img className="img-fluid mt-5" src="/img/header.png" alt="Learning Illustration" style={{ maxHeight: '400px' }} />
          </div>
        </div>
      </div>
      ...
      <div className="container my-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 mb-4">
            ...
            <Link to="/about" className="btn btn-outline-primary mt-3">Learn More About Us</Link>
          </div>
        </div>
      </div>
      ...
      <div className="container py-5 text-center">
        ...
        <Link to="/contact" className="btn btn-outline-primary mt-3">Contact Us</Link>
      </div>
    </>
  );
}
